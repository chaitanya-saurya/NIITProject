    ...
    public RegisterEMP() {
        ...
        avail.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    PreparedStatement pstmt = conn.prepareStatement("SELECT user_name FROM EMP where user_name=?");
        ...
        RButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    conn = JDBCConfiguration.getDBConnection();
                    String query = "INSERT INTO EMP values('" + firstName + "','" + lastName + "','" + userName + "','" +
                            password + "','" + emailId + "','" + mobileNumber +"','" + radioText +"','" + stats +"','" + newRole +"','" + job +"')";
