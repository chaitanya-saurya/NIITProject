...
public class RegisterHR extends JFrame {
        ...
        avail.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    PreparedStatement pstmt = conn.prepareStatement("SELECT user_name FROM HR where user_name=?");
        ...
        RButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String query = "INSERT INTO HR values('" + firstName + "','" + lastName + "','" + userName + "','" +
